...
\begin{theorem}[Quantum Theory from 4 Axioms]
Causal invariance implies quantum mechanics via four operational axioms, with local distinguishability as emergent consequence.
\end{theorem}

\begin{proof}
We employ Chiribella et al.~\cite{Chiribella2011} operational framework, showing CI implies four axioms:
