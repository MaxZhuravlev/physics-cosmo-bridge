...
\author{Max Zhuravlev\thanks{Independent researcher. Email: \texttt{max@vibecodium.com}}}
...
A rigorous upper bound on $C$ remains an open problem; the bound
stated here is empirical (71 configurations, all satisfying
$C \lesssim 15$).
\end{proof}
