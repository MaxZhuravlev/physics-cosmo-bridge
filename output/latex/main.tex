...
and the effective constant $C(g, \Delta)$ is empirically determined
to grow at most linearly in~$g$ for fixed~$\Delta$
($C \lesssim 0.7\,g$ on cycle graphs with $g = 3$ to~$12$,
$J = 0.1$ to~$1.0$, 50~configurations; a rigorous derivation of~$C$
remains open).
